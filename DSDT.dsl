DefinitionBlock ("dsdt.aml", "DSDT", 2, "ALASKA", "A M I", 0x00000012)
{
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xBE226E18, 0x01CD)
    ...
    Scope (_SB)
    {
        ...
        Device (PCI0)
        {
            ...
            Device (LPCB)
            {
                ...
                Name (LUCD, Buffer (0x7D)
                {
                    ...
                    /* 0010 */   0x00, 0x00, 0x00, 0xE0, 0xF0, 0x35, 0x65, 0x37,
                    ...
                    /* 0030 */   0x64, 0x31, 0x65, 0x64, 0x61, 0x32, 0x63, 0x31,
                    /* 0038 */   0x34, 0x31, 0x38, 0x38, 0x33, 0x65, 0x36, 0x39,
                    /* 0040 */   0x63, 0x63, 0x35, 0x61, 0x65, 0x31, 0x38, 0x37,
                    /* 0048 */   0x66, 0x39, 0x64, 0x37, 0x37, 0x39, 0x66, 0x35,
                    /* 0050 */   0x66, 0x30, 0x30, 0x66, 0x64, 0x30, 0x30, 0x30,
                    /* 0058 */   0x30, 0x32, 0x36, 0x45, 0x38, 0x63, 0x65, 0x64,
        ...
        Scope (\_GPE)
        {
            ...
            {
                Notify (\_SB.PCI0.RP01.FWBR.FRWR, 0x00)
            }
    ...
    Scope (_SB.PCI0.LPCB)
    {
        OperationRegion (CPSB, SystemMemory, 0xBE0FBF98, 0x10)
    ...
    Scope (_SB.PCI0)
    {
        ...
        {
            "374937846529Genuine NVIDIA Certified SLI Ready Motherboard for GIGABYTE GAZ68XP-UD39d38-Copyright 2010 NVIDIA Corporation All Rights Reserved-458103946203(R)"
        })
        Device (WMI1)
        {
            Name (_HID, "PNP0C14")
